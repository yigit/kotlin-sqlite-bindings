...
import com.birbit.ksqlite3.ColumnType
import com.birbit.ksqlite3.ResultCode
...
@CName("Java_com_birbit_ksqlite3_internal_SqliteApi_nativeOpenConnection")
fun openConnection(
...
@CName("Java_com_birbit_ksqlite3_internal_SqliteApi_nativePrepareStmt")
fun prepareStmt(
    env: CPointer<JNIEnvVar>,
    clazz: jclass,
    p0: jlong,
...
@CName("Java_com_birbit_ksqlite3_internal_SqliteApi_nativeStep")
fun step(
    env: CPointer<JNIEnvVar>,
    clazz: jclass,
    p0: jlong
...
@CName("Java_com_birbit_ksqlite3_internal_SqliteApi_nativeColumnText")
fun columnText(
    env: CPointer<JNIEnvVar>,
    clazz: jclass,
    p0: jlong,
...
@CName("Java_com_birbit_ksqlite3_internal_SqliteApi_nativeColumnInt")
fun columnInt(
    env: CPointer<JNIEnvVar>,
    clazz: jclass,
    p0: jlong,
...
@CName("Java_com_birbit_ksqlite3_internal_SqliteApi_nativeColumnIsNull")
fun columnIsNull(
    env: CPointer<JNIEnvVar>,
    clazz: jclass,
    p0: jlong,
...
@CName("Java_com_birbit_ksqlite3_internal_SqliteApi_nativeReset")
fun reset(
    env: CPointer<JNIEnvVar>,
    clazz: jclass,
    p0: jlong
...
@CName("Java_com_birbit_ksqlite3_internal_SqliteApi_nativeClose")
fun close(
    env: CPointer<JNIEnvVar>,
    clazz: jclass,
    p0: jlong
...
@CName("Java_com_birbit_ksqlite3_internal_SqliteApi_nativeFinalize")
fun finalize(
    env: CPointer<JNIEnvVar>,
    clazz: jclass,
    p0: jlong
...
@CName("Java_com_birbit_ksqlite3_internal_SqliteApi_nativeColumnBlob")
fun columnBlob(
    env: CPointer<JNIEnvVar>,
    clazz: jclass,
    p0: jlong,
...
@CName("Java_com_birbit_ksqlite3_internal_SqliteApi_nativeColumnDouble")
fun columnDouble(
    env: CPointer<JNIEnvVar>,
    clazz: jclass,
    p0: jlong,
...
@CName("Java_com_birbit_ksqlite3_internal_SqliteApi_nativeColumnLong")
fun columnLong(
    env: CPointer<JNIEnvVar>,
    clazz: jclass,
    p0: jlong,
...
@CName("Java_com_birbit_ksqlite3_internal_SqliteApi_nativeBindBlob")
fun bindBlob(
    env: CPointer<JNIEnvVar>,
    clazz: jclass,
    p0: jlong,
...
@CName("Java_com_birbit_ksqlite3_internal_SqliteApi_nativeBindText")
fun bindText(
    env: CPointer<JNIEnvVar>,
    clazz: jclass,
    p0: jlong,
...
@CName("Java_com_birbit_ksqlite3_internal_SqliteApi_nativeBindInt")
fun bindInt(
    env: CPointer<JNIEnvVar>,
    clazz: jclass,
    p0: jlong,
...
@CName("Java_com_birbit_ksqlite3_internal_SqliteApi_nativeBindLong")
fun bindLong(
    env: CPointer<JNIEnvVar>,
    clazz: jclass,
    p0: jlong,
...
@CName("Java_com_birbit_ksqlite3_internal_SqliteApi_nativeBindNull")
fun bindNull(
    env: CPointer<JNIEnvVar>,
    clazz: jclass,
    p0: jlong,
...
@CName("Java_com_birbit_ksqlite3_internal_SqliteApi_nativeErrorMsg")
fun errorMsg(
    env: CPointer<JNIEnvVar>,
    clazz: jclass,
    p0: jlong
...
@CName("Java_com_birbit_ksqlite3_internal_SqliteApi_nativeErrorCode")
fun errorCode(
    env: CPointer<JNIEnvVar>,
    clazz: jclass,
    p0: jlong
...
@CName("Java_com_birbit_ksqlite3_internal_SqliteApi_nativeErrorString")
fun errorString(
    env: CPointer<JNIEnvVar>,
    clazz: jclass,
    p0: ResultCode
...
@CName("Java_com_birbit_ksqlite3_internal_SqliteApi_nativeBindDouble")
fun bindDouble(
    env: CPointer<JNIEnvVar>,
    clazz: jclass,
    p0: jlong,
...
@CName("Java_com_birbit_ksqlite3_internal_SqliteApi_nativeSetAuthorizer")
fun setAuthorizer(
    env: CPointer<JNIEnvVar>,
    clazz: jclass,
    p0: jlong,
...
@CName("Java_com_birbit_ksqlite3_internal_SqliteApi_nativeColumnType")
fun columnType(
    env: CPointer<JNIEnvVar>,
    clazz: jclass,
    p0: jlong,
...
@CName("Java_com_birbit_ksqlite3_internal_SqliteApi_nativeExec")
fun exec(
    env: CPointer<JNIEnvVar>,
    clazz: jclass,
    p0: jlong,
...
@CName("Java_com_birbit_ksqlite3_internal_SqliteApi_nativeColumnDeclType")
fun columnDeclType(
    env: CPointer<JNIEnvVar>,
    clazz: jclass,
    p0: jlong,
...
@CName("Java_com_birbit_ksqlite3_internal_SqliteApi_nativeColumnDatabaseName")
...
@CName("Java_com_birbit_ksqlite3_internal_SqliteApi_nativeColumnTableName")
fun columnTableName(
    env: CPointer<JNIEnvVar>,
    clazz: jclass,
    p0: jlong,
...
@CName("Java_com_birbit_ksqlite3_internal_SqliteApi_nativeColumnOriginName")
...
@CName("Java_com_birbit_ksqlite3_internal_SqliteApi_nativeColumnCount")
fun columnCount(
    env: CPointer<JNIEnvVar>,
    clazz: jclass,
    p0: jlong
...
@CName("Java_com_birbit_ksqlite3_internal_SqliteApi_nativeColumnName")
fun columnName(
    env: CPointer<JNIEnvVar>,
    clazz: jclass,
    p0: jlong,
...
@CName("Java_com_birbit_ksqlite3_internal_SqliteApi_nativeExpandedSql")
fun expandedSql(
    env: CPointer<JNIEnvVar>,
    clazz: jclass,
    p0: jlong
...
@CName("Java_com_birbit_ksqlite3_internal_SqliteApi_nativeNormalizedSql")
fun normalizedSql(
    env: CPointer<JNIEnvVar>,
    clazz: jclass,
    p0: jlong
...
@CName("Java_com_birbit_ksqlite3_internal_SqliteApi_nativeSql")
fun sql(
    env: CPointer<JNIEnvVar>,
    clazz: jclass,
    p0: jlong
...
@CName("Java_com_birbit_ksqlite3_internal_SqliteApi_nativeBindParameterCount")
...
@CName("Java_com_birbit_ksqlite3_internal_SqliteApi_nativeBindParameterName")
...
@CName("Java_com_birbit_ksqlite3_internal_SqliteApi_nativeBindParameterIndex")
